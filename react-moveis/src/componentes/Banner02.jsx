      ...
      <div className="row justify-content-center">
        <div className="col-sm-8 position-relative coluna01">
          <a href="http://">
            ...
            <img
              className="img-dark"
              src="https://lojamultilaser.vtexassets.com/arquivos/ids/1400162-800-auto?v=638781040119700000&width=800&height=auto&aspect=true"
        ...
        <div className="col-sm-4 imgDireita ">
          <div className="position-relative02">
            <a href="http://">
              ...
              <img
                src="https://m.media-amazon.com/images/I/71OgQUaaHaL._AC_UF894,1000_QL80_.jpg"
                alt="Cadeira"
              />
            </a>
          </div>
          ...
          <div className="position-relative02">
            ...
            <img
              src="https://down-br.img.susercontent.com/file/br-11134207-7r98o-lwwxntm9vw5231"
              alt="Cadeira"
            />
            </a>
          </div>
